...
### Роль Hallucination Checker

В проекте реализована роль `hallucination_checker` для выявления потенциальных галлюцинаций в ответах ИИ. Роль анализирует:

- Соответствие ответов исходным требованиям
- Консистентность в рамках диалога
- Корректность технических решений
- Использование только разрешённых библиотек и подходов

Подробнее о разработке и тестировании роли см. в директории `prompt_logs/`.
